...
<body>
  ...
  <h4 style="color: black; text-align: center">Proveedores</h4>
...
<table style="width: 100%;">
  ...
  @foreach ($providers as $provider)
    <tr>
      ...
      <td style="text-align: center; ">{{ $provider->razon_social ?? ''}}</td>
      <td style="text-align: center; ">{{ $provider->direction ?? '' }}</td>
      <td style="text-align: center; ">{{ $provider->phone1 ?? '' }}</td>
